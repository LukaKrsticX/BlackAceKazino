...
function ModeratorNavbar ({ userData, onLogout, balance}) {
      ...
      <div className="collapse navbar-collapse" id="mobile-nav">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item">
            <span className="nav-link">Welcome Moderator, {userData.userName}</span>
          </li>
        </ul>
        ...
        <li className="nav-item">
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/ModeratorDashboard">Moderator Dashboard</Link>
          </li>
          <li className="nav-item">
